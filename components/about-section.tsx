          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Desde 2013, hemos ayudado a miles de empresas a transformar sus procesos y alcanzar el éxito digital.
                Nuestra misión es democratizar el acceso a tecnología de clase mundial.
              </p>
            </div>
